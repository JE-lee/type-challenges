...
## Answer
```typescript
type Pop<T extends readonly any[]> = T extends [...infer R, infer U] ? R : never
```

[check in ts playground](https://www.typescriptlang.org/play?#code/C4TwDgpgBAhgTnAjFAvFA2gchpgNFTAIzwIGMTMATTAXQChRJYEAmVDAZnxf0XofDQACgHswAHgAqUCAA9gEAHaUAzlDgQYlEYoA2IWIpDoaAPnbS5C5WvQA6BwEtFAMwhwoAJXzO3HgKo0UAD8XlAAXFCKEABu7nQCTBrIaKIS8EjmAPRZMrKQpAqUUMAiUITQWDj4RBTk9IzQGmypYuIZLNm5cgVFJWUVnNw0QA)
