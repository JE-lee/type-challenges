...
## Answer
```typescript
type TrimLeft<T extends string> = T extends  `${infer U}${infer R}` ? (U extends ' ' ? TrimLeft<R> : T) : never
```

[check in ts playground](https://www.typescriptlang.org/play?#code/PTAEEsFsAcBsFNLwC4ENngPYDsBQyBPaeUAFQCcoAZeAM2QB5TR4APZebAEwGdQfklbAHMAfKAC8ZFu069QoAAYASAN7hsteOVABVAL5qNWnQCV9i0AH5QACl0yO3PgHJQbmxWp1Gp8QC4yAEpQQOx4ADdtfCISQSh4LkkySkgaegY3UAAJeFhYTFAAdUxyWCT3cRAZYgBjDiTkQoAjEhdc-MKSsoqXIA)
